...
namespace Fsb\Bundle\ProxyBundle\Provider;
...
class YamlUserProvider implements UserProviderInterface
{
	...
	public function loadUserByUsername($username)
	{
		...
		if ($users && array_key_exists($username, $users)) {
			return new User($username, $users[$username]['password'], $users[$username]['salt'], array('ROLE_USER'));
		}
	...
	{
		return ('Fsb\Bundle\ProxyBundle\Model\User' === $class) || (is_subclass_of($class, 'Fsb\Bundle\ProxyBundle\Model\User'));
	}
}
